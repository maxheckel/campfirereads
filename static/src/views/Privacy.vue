<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
    ...
    <h1 class="text-4xl font-bold my-4 font-serif">Interpretation and Definitions</h1>
    ...
    <ul>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
          or &quot;Our&quot; in this Agreement) refers to Campfire Reads.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to Campfire Reads, accessible from <a href="https://readmailercampfirereads.com"
                                                                             rel="external nofollow noopener"
                                                                             target="_blank">https://campfirereads.com</a>
        </p>
      </li>
      <li>
    ...
    <h1 class="text-4xl font-bold my-4 font-serif">Collecting and Using Your Personal Data</h1>
    ...
    <h1 class="text-4xl font-bold my-4 font-serif">Detailed Information on the Processing of Your Personal Data</h1>
    ...
    <ul>
      <li>
        ...
        <p>For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms
          web page: <a href="https://policies.google.com/privacy" rel="external nofollow noopener"
    ...
    <ul>
      <li>
        ...
        <p>Their Privacy Policy can be viewed at <a href="https://www.mailgun.com/legal/privacy-policy/"
                                                    rel="external nofollow noopener" target="_blank">https://www.mailgun.com/legal/privacy-policy/</a>
        </p>
      </li>
    </ul>
    <h2>Payments</h2>
    ...
    <h1 class="text-4xl font-bold my-4 font-serif">Children's Privacy</h1>
    ...
    <h1 class="text-4xl font-bold my-4 font-serif">Links to Other Websites</h1>
    ...
    <h1 class="text-4xl font-bold my-4 font-serif">Changes to this Privacy Policy</h1>
    ...
    <h1 class="text-4xl font-bold my-4 font-serif">Contact Us</h1>
    <p>If you have any questions about this Privacy Policy, You can contact us:</p>
    <ul>
      <li>By email: <a href="mailto:support@campfirereads.com">support@campfirereads.com</a>
      </li>
    </ul>
