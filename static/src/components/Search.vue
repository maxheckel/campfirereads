  ...
  <form>
    ...
    <div class="relative">
      ...
      <input v-model="data.query" type="search" id="default-search"
             class="block p-4 pl-10 w-full text-sm text-gray-900  rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 d dark:border-gray-600 dark:placeholder-gray-400 dark:text-np-dark-brown dark:focus:ring-blue-500 dark:focus:border-blue-500"
...
function search() {
   window.location = '/search?q='+data.query
}
</script>
